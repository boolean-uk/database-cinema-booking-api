...
/*const updateCustomerById = async (id, request_body) => {
  const { name, contact, tickets, createdAt, updatedAt } = request_body;
  const updatedCustomer = await updateCustomerByIdDB;
