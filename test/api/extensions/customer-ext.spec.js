...
describe("Customer Endpoint", () => {
  describe("PUT /customers/:id", () => {
    it("can update a customer's contact info when a contact property exists on the request body", async () => {
      ...
      expect(response.status).toEqual(200); // Correcting the expected status code to 200
